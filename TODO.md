...
- [ ] Add bundle size comparison (JS vs WASM)
- [ ] Support more example schemas (arrays of objects, recursive structures, etc.)
- [ ] Add CI check to ensure demo examples stay in sync with schemas
